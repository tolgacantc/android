...
import com.example.canto.myfirstapplication.sqlite.CountriesTableConstants;
...
public class ListCountryActivity extends AppCompatActivity {
    ...
    final String[] from = new String[] { CountriesTableConstants._ID,
            CountriesTableConstants.SUBJECT, CountriesTableConstants.DESC };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new SimpleCursorAdapter(this, R.layout.country_activity_view_record, cursor, from, to, 0);
